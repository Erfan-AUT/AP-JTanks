...
public class User {
    ...
    private int lastUpdatedCameraZeroX;
    private int lastUpdatedCameraZeroY;
    ...
    public User(Map map, boolean trueForServerFalseForClient) {
        ...
        lastUpdatedCameraZeroX = 0;
        lastUpdatedCameraZeroY = 0;
    }
    ...
    class KeyHandler implements KeyListener {
        ...
        public void keyTyped(KeyEvent e) {
            mouseX += map.getCameraZeroX();
            mouseX -= lastUpdatedCameraZeroX;
            mouseY += map.getCameraZeroY();
            mouseY -= lastUpdatedCameraZeroY;
            lastUpdatedCameraZeroX = map.getCameraZeroX();
            lastUpdatedCameraZeroY = map.getCameraZeroY();
        }
        ...
        public void keyPressed(KeyEvent e) {
            ...
            switch (e.getKeyCode()) {
                ...
                case KeyEvent.VK_D:
                    keyRIGHT = true;
//                    System.out.println(MouseInfo + map.getCameraZeroX());
//                    System.out.println(a.getLocation().getY() + map.getCameraZeroY());
                    break;
                case KeyEvent.VK_A:
                    keyLEFT = true;
                    break;
